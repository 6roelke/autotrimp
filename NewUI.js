...
createSetting('RunNewVoids', 'Run New Voids', 'Run new void maps acquired after the set void map zone. CAUTION: May severely slow you down by trying to do too-high level voidmaps. Use the adjacent RunNewVoidsUntil setting to limit this.', 'boolean', null, null, 'advancedSettings');
...
createSetting('FarmingCutoff', 'Farming Cutoff', 'The script will farm if enemyHealth/baseDamage rises above this number.', 'value', '0', null, 'genbtcadvancedSettings');
