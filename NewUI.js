...
createSetting('HeliumHrBuffer', 'Helium/Hr Buffer %', '' , 'value', '0', null, 'genbtcadvancedSettings');
autoTrimpSettings["HeliumHrBuffer"].description = 'When using the He/Hr Autoportal, it will portal if your He/Hr drops below ' + getPageSetting('HeliumHrBuffer') +'% of your best for current run, default is 0%';
